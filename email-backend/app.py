...
def api_send_reset_link():
    ...
    reset_url = f"{BASE_URL}/app/?reset_token={token}"
...
def api_payment_create_redirect():
    ...
    # Build URLs (Cryptomus: url_return = back before paying, url_success = after successful payment)
    url_return = f"{BASE_URL}/?user_id={user_id}&page=payment"
    url_success = f"{BASE_URL}/?user_id={user_id}&page=payment&payment=success"
